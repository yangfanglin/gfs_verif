...
export vname_SNODsfc="Surface Snow Depth [cm] "
export scale_SNODsfc=100
export clevs0_SNODsfc="  1     5    10  20  40  60    80  100  150 200 250"                       
export color0_SNODsfc=" 0   32   33   34  36  37   39   42   44  46  47  49"                      
export clevs_SNODsfc="  -40   -20  -10  -5    -1     -0.1   0.1   1    5    10  20  40 "           
...
export vname_UGRD100m="100m Above Ground Zonal Wind [m/s] "
...
export vname_UGRD80m="80m Above Ground Zonal Wind [m/s] "
...
export vname_UGRD10m="10m Above Ground Zonal Wind [m/s] "
