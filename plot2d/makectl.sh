...
REFDhy2   0,105,2   0,16,195 ** 2 hybrid level Reflectivity [dB]
...
TCDCclm     0,200,0   0,6,1,0 ** entire atmosphere Total Cloud Cover [%]
TCDChcl      0,234,0   0,6,5,0 ** high cloud layer High Cloud Cover [%]
TCDCmcl      0,224,0   0,6,4,0 ** middle cloud layer Medium Cloud Cover [%]
TCDClcl      0,214,0   0,6,3,0 ** low cloud layer Low Cloud Cover [%]
...
TCDClcl       0 73,214,0 ** low cloud level Total cloud cover [%]
TCDCmcl       0 74,224,0 ** mid-cloud level Total cloud cover [%]
TCDChcl       0 75,234,0 ** high cloud level Total cloud cover [%]
...
$grbmap -0 -i $ctldir/${exp}_${hr}.ctl     
