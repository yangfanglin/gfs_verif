...
export nlev=64                                ;#sig file vertical layers, fixed for 64-L GFS
...
m=1; while [ $m -le $mjob ]; do
 ...
 varlist3="HPSSTAR,SUBJOB,ACCOUNT,CUE2RUN,CUE2FTP,GROUP,batch,APRUN"                                          
...
#------------------------------
export ctl${n}a=${rundir}/ctl/${exp}_${dump}anl.ctl
export ctl${n}g=${rundir}/ctl/${exp}_${dump}ges.ctl
n=$((n+1))
done
#------------------------------
