...
export caplist=${caplist:-$expnlist}               ;#experiment names to display on graphics
...
EOF
  ...
  $SUBJOB -a $ACCOUNT -q $CUE2FTP -g $GROUP -p 1/1/S -t 0:30:00 -r 256/1 -j ftprain -o ftprain.out $rundir/ftprain.sh 
#--------------------------------------------
fi
#--------------------------------------------
