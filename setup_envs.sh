...
if [ $machine = WCOSS2 ]; then
 ...
 export gstat=/lfs/h2/emc/physics/noscrub/fanglin.yang/data/ops/global                   ;#global stats directory              
...
#----------------------------
 ...
 export GRADSBIN=/apps/grads/2.2.3_gcc_13.2.0/bin           ;#GrADS executables
 export IMGCONVERT=/apps/ImageMagick/7.1.1-11_gnu_13.2.0/bin/convert                    
