...
#-------------------------------
  if [ $copymap = "YES" ]; then
    mkdir -p $mapdir/g2o_${cyc}Z/air/bias
    cp bias*.png  $mapdir/g2o_${cyc}Z/air/bias/.
    mkdir -p $mapdir/g2o_${cyc}Z/air/rms
    cp rms*.png  $mapdir/g2o_${cyc}Z/air/rms/.
  fi
#------------------------------
...
cat << EOF >ftpin
  binary
  promt
  cd $ftpdir/g2o/g2o_${cyc}Z/air/bias
  mput bias*${namedaily}.png
  cd $ftpdir/g2o/g2o_${cyc}Z/air/rms
