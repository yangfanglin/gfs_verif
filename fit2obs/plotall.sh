...
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/vertplot_$exp.out \
...
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/vertplot_$sdir.out \
...
if [ $exp = timeout ]; then
 ...
 $SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/timeout.newb.out $SCRIPTS/timeout.newb
 continue
fi
...
if [ $exp = timevrt ]; then
 export pdir=$ptdir;  mkdir -p $pdir; echo "exp is $exp"
 export listvar=quan,edate,edate12,sdate,sdate12,var,exp1,exp2,pdir,web,webdir,localdir,SCRIPTS,GSCRIPTS,ctldir,namstr,webmch,webid,GRADSBIN,IMGCONVERT,oinc_f2o,finc_f2o,fmax_f2o,expnlist,expdlist,SORC,CTLS,ndate
 $SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/timevrt.newb.out $SCRIPTS/timevrt.newb
 continue
fi
...
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/time${var}_$exp.out \
$SCRIPTS/time${var}.newb
done

export pdir=$ptdir/acar; mkdir -p $pdir
export listvar=edate,edate12,sdate,sdate12,var,exp,pdir,web,webdir,localdir,SCRIPTS,GSCRIPTS,ctldir,namstr,webmch,webid,GRADSBIN,stnmap,IMGCONVERT,ndate
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/timeacar_$exp.out \
$SCRIPTS/timeacar.newb

export pdir=$ptdir/acft;  mkdir -p $pdir
export listvar=edate,edate12,sdate,sdate12,var,exp,pdir,web,webdir,localdir,SCRIPTS,GSCRIPTS,ctldir,namstr,webmch,webid,GRADSBIN,stnmap,IMGCONVERT,ndate
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/timeacft_$exp.out \
...
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/time${var}_$sdir.out \
...
export listvar=edate,edate12,sdate,sdate12,var,exp1,exp2,fcs1,fcs2,pdir,web,webdir,localdir,SCRIPTS,GSCRIPTS,ctldir,namstr,webmch,webid,GRADSBIN,stnmap,IMGCONVERT
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/timeacar_$sdir.out \
...
export listvar=edate,edate12,sdate,sdate12,var,exp1,exp2,fcs1,fcs2,pdir,web,webdir,localdir,SCRIPTS,GSCRIPTS,ctldir,namstr,webmch,webid,GRADSBIN,stnmap,IMGCONVERT
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/timeacft_$sdir.out  \
...
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/f00plots_$exp2.out \
...
export listvar=edate,edate12,sdate,sdate12,minday,exp1dir,exp2dir,exp1,exp2,pdir,GSCRIPTS,SCRIPTS,web,webdir,localdir,namstr,webmch,webid,GRADSBIN,stnmap,IMGCONVERT
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/f12plots_$exp2.out \
...
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/horizab_$exp.out \
...
export listvar=edate,edate12,sdate,sdate12,minday,expdir,exp,pdir,GSCRIPTS,SCRIPTS,web,webdir,localdir,namstr,webmch,webid,GRADSBIN,stnmap,IMGCONVERT
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/horizrab_$exp.out \
...
export listvar=edate,edate12,sdate,sdate12,minday,expdir,exp,pdir,GSCRIPTS,SCRIPTS,web,webdir,localdir,namstr,webmch,webid,GRADSBIN,stnmap,IMGCONVERT
$SUBJOB -e $listvar -a $task  -q $cue -g $GROUP -p 1/1/S -r 512/1 -t $cputime  -o $PROUT/sfcab_$exp.out \
  $SCRIPTS/sfcab.cdas
